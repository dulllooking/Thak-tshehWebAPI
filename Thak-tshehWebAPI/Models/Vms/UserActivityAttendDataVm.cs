...
namespace Thak_tshehWebAPI.Models.Vms
{
    ...
    /// 會員參加活動資料回應
    /// </summary>
    public class UserActivityAttendDataVm
    {
        /// <summary>
        /// 狀態
        /// </summary>
        ...
        /// 會員參加活動資料內容
        /// </summary>
        public UserActivityAttendData Data { get; set; }
    }

    /// <summary>
    /// 會員參加活動資料內容
    /// </summary>
    public class UserActivityAttendData
    {
        /// <summary>
        /// 會員參加活動資料頁數
        /// </summary>
        ...
        /// 會員參加活動資料
        /// </summary>
        public ActivityAttendDetail[] MyActivity { get; set; }
    }

    /// <summary>
    /// 會員參加活動資料
    /// </summary>
    public class ActivityAttendDetail
    {
        /// <summary>
        /// 活動編號
        /// </summary>
